...
but each defense only counters *some* threat types, so you have to combine them, just like
...
4. Click a deployed tower to see its info or sell it back for parts of its cost.
